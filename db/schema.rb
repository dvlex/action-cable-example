...
ActiveRecord::Schema[8.1].define(version: 2026_04_24_224928) do
  ...
  create_table "alchemy_users", id: :serial, force: :cascade do |t|
    ...
    t.string "timezone", comment: "The timezone of the user, used for displaying dates in the user's timezone"
